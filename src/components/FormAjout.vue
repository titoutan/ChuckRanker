<template>
  <button @click="toggleVisible()">Ajouter votre phrase</button>
  ...
  <form v-if="visible" action="" @submit.prevent="handleSubmit()">
    ...
    <textarea autofocus v-model="phrase" type="text" name="" id="" cols="33" rows="5" autocomplete="off" placeholder="Votre phrase de Chuck Norris..."></textarea>
...
button:hover {
  box-shadow: inset 0 0 0 1em #43da96;
}
.backdrop {
  position: absolute;
  top:0;
